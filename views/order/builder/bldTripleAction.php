<div class="modal-button">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#windowModal4">
        Τριφυλλο
        </button>
    </div>

    <div class="modal fade" tabindex="-1" id="windowModal4">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="builder-container">
              ...
              <br>
              <div>
                <img src="./images/3P-SLD-RLL.jpg" alt="3P-SLD-RLL.jpg">
              </div>
